...
import torch
from diffusion.model.sd35.text_impls import SD3Tokenizer, SDClipModel, SDXLClipG, T5XXLModel
...
class TextEncoder:
    ...
    def get_cond(self, prompts):
        ...
        # print("clip_l:", l_out.shape, l_pooled.shape)
        # print("clip_g:", g_out.shape, g_pooled.shape)
        # print("t5_xxl:", t5_out.shape)
        t2 = time.time()
...
if __name__ == "__main__":
    ...
    tokens = txt_enc.encode(PROMPT)
    print(tokens["g"][0].shape, tokens["g"][1].shape)
    print(tokens["l"][0].shape, tokens["l"][1].shape)
    print(tokens["t5xxl"][0].shape)
