...
class DataConfig(BaseConfig):
    ...
    data: Any = None
    extra: Any = None
    dset: str = "train_brief"    # ["train_brief", "test_brief", "train_detail", "test_detail"]
    max_samples: Any = None
    use_tokens: str = "prefill"  # "hidden_state", "prefill", "ALL"
    max_tokens: int = 400 
    caption_type: str = "question" # "question", "GT", "IQA": "question" # "question", "GT", "IQA"
    return_meta: bool = False
    need_resize: bool = True
    synthetic_composite: bool = False
    input_file: str = None

@dataclass
class ModelConfig(BaseConfig):
    model: str = "SD35M_P2P"
    model_pretrained: str = "../checkpoints/stable-diffusion-3.5-medium/sd3.5_medium.safetensors"
    shift: float = 3.0
...
class AEConfig(BaseConfig):
    vae_type: str = "SDVAE"
    vae_pretrained: str = "../checkpoints/stable-diffusion-3.5-medium/sd3.5_medium.safetensors"
...
class TextEncoderConfig(BaseConfig):
    text_encoder_name: str = "sd35-text"
    text_encoder_pretrained: str = "../checkpoints/stable-diffusion-3.5-medium/text_encoders"
...
class ConnectorConfig(BaseConfig):
    ...
    input_channel: int = 4096
    num_input_tokens: int = 400
    num_query_tokens: int = 77
    hidden_dim: int = 1024
    layers: int = 8
    heads: int = 16
...
class AssessmentConfig(BaseConfig):
    model: str = "SDQA"
    model_config: str = "../iqa/config.yaml"
...
class SchedulerConfig(BaseConfig):
    ...
    extra: Any = None
    recur_round: int = 1
    recur_truncated: bool = False
    recur_loss_weights: List[float] = field(
        default_factory=lambda: [
            1.0
        ]
    )
...
class TrainingConfig(BaseConfig):
    train_type: str = "fp32"  # bf16, fp16, fp32
    resume_from: str = None 
    num_workers: int = 4
    seed: int = 42
