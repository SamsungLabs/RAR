...
class SpacedDiffusion(GaussianDiffusion):
    ...
    def training_losses_p2p(self, model, *args, **kwargs):  # pylint: disable=signature-differs
        return super().training_losses_p2p(self._wrap_model(model), *args, **kwargs)

    def training_losses_d2c(self, model, *args, **kwargs):  # pylint: disable=signature-differs
        return super().training_losses_d2c(self._wrap_model(model), *args, **kwargs)
